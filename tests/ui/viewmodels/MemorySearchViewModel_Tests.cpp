...
private:
    ...
    void AssertRow(MemorySearchViewModelHarness& search, gsl::index nRow, ra::data::ByteAddress nAddress,
...
public:
    TEST_METHOD(TestInitialValues)
    {
        ...
        Assert::AreEqual({ 14U }, search.SearchTypes().Count());
        ...
        Assert::AreEqual((int)ra::services::SearchType::SixteenBitBigEndian, search.SearchTypes().GetItemAt(4)->GetId());
        Assert::AreEqual(std::wstring(L"16-bit BE"), search.SearchTypes().GetItemAt(4)->GetLabel());
        Assert::AreEqual((int)ra::services::SearchType::ThirtyTwoBitBigEndian, search.SearchTypes().GetItemAt(5)->GetId());
        Assert::AreEqual(std::wstring(L"32-bit BE"), search.SearchTypes().GetItemAt(5)->GetLabel());
        Assert::AreEqual((int)ra::services::SearchType::BitCount, search.SearchTypes().GetItemAt(6)->GetId());
        Assert::AreEqual(std::wstring(L"BitCount"), search.SearchTypes().GetItemAt(6)->GetLabel());
        Assert::AreEqual((int)ra::services::SearchType::Float, search.SearchTypes().GetItemAt(7)->GetId());
        Assert::AreEqual(std::wstring(L"Float"), search.SearchTypes().GetItemAt(7)->GetLabel());
        Assert::AreEqual((int)ra::services::SearchType::FloatBigEndian, search.SearchTypes().GetItemAt(8)->GetId());
        Assert::AreEqual(std::wstring(L"Float BE"), search.SearchTypes().GetItemAt(8)->GetLabel());
        Assert::AreEqual((int)ra::services::SearchType::Double32, search.SearchTypes().GetItemAt(9)->GetId());
        Assert::AreEqual(std::wstring(L"Double32"), search.SearchTypes().GetItemAt(9)->GetLabel());
        Assert::AreEqual((int)ra::services::SearchType::Double32BigEndian, search.SearchTypes().GetItemAt(10)->GetId());
        Assert::AreEqual(std::wstring(L"Double32 BE"), search.SearchTypes().GetItemAt(10)->GetLabel());
        Assert::AreEqual((int)ra::services::SearchType::MBF32, search.SearchTypes().GetItemAt(11)->GetId());
        Assert::AreEqual(std::wstring(L"MBF32"), search.SearchTypes().GetItemAt(11)->GetLabel());
        Assert::AreEqual((int)ra::services::SearchType::MBF32LE, search.SearchTypes().GetItemAt(12)->GetId());
        Assert::AreEqual(std::wstring(L"MBF32 LE"), search.SearchTypes().GetItemAt(12)->GetLabel());
    ...
    TEST_METHOD(TestBeginNewSearchEightBit)
    {
        ...
        Assert::AreEqual(ra::data::Memory::Size::EightBit, search.ResultMemSize());
    ...
    TEST_METHOD(TestBeginNewSearchSixteenBit)
    {
        ...
        Assert::AreEqual(ra::data::Memory::Size::SixteenBit, search.ResultMemSize());
    ...
    TEST_METHOD(TestApplyFilterAsciiTextConstant)
    {
        ...
        Assert::AreEqual(std::wstring(L"1/1"), search.GetSelectedPage());
        Assert::AreEqual({ 2U }, search.GetResultCount());
        Assert::AreEqual(ra::data::Memory::Size::Text, search.ResultMemSize());
    ...
    TEST_METHOD(TestBookmarkSelectedText)
    {
        ...
        Assert::AreEqual(ra::data::Memory::Size::Text, pBookmarks.Items().GetItemAt(0)->GetSize());
        Assert::IsTrue(search.Results().GetItemAt(0)->IsSelected());
    }
    ...
    TEST_METHOD(TestPredefinedFilterRangeOnlySystem)
    {
        ...
        search.mockEmulatorMemoryContext.MockTotalMemorySizeChanged(0x10000U);
