...
private:
    ...
    TEST_METHOD(TestGetPopupMenuItemsNotLoggedIn)
    {
        ...
        const RA_MenuItem* menu_ptr = &menu[0];
        AssertMenuItem(menu_ptr++, IDM_RA_FILES_LOGIN, L"&Login");
        AssertMenuItem(menu_ptr++, 0, nullptr);
        AssertMenuItem(menu_ptr++, IDM_RA_HARDCORE_MODE, L"&Hardcore Mode");
        AssertMenuItem(menu_ptr++, IDM_RA_NON_HARDCORE_WARNING, L"Non-Hardcore &Warning");
        AssertMenuItem(menu_ptr++, IDM_RA_ONLY_HARDCORE_UNLOCKS, L"Only Hardcore Unloc&ks");
        AssertMenuItem(menu_ptr++, 0, nullptr);
        AssertMenuItem(menu_ptr++, IDM_RA_TOGGLELEADERBOARDS, L"Enable &Leaderboards");
        AssertMenuItem(menu_ptr++, IDM_RA_OVERLAYSETTINGS, L"O&verlay Settings");
        AssertMenuItem(menu_ptr++, 0, nullptr);
        AssertMenuItem(menu_ptr++, IDM_RA_FILES_OPENALL, L"&Open All");
        AssertMenuItem(menu_ptr++, IDM_RA_FILES_ACHIEVEMENTS, L"Assets Li&st");
        AssertMenuItem(menu_ptr++, IDM_RA_FILES_ACHIEVEMENTEDITOR, L"Assets &Editor");
        AssertMenuItem(menu_ptr++, IDM_RA_FILES_MEMORYFINDER, L"&Memory Inspector");
        AssertMenuItem(menu_ptr++, IDM_RA_FILES_MEMORYBOOKMARKS, L"Memory &Bookmarks");
        AssertMenuItem(menu_ptr++, IDM_RA_FILES_CODENOTES, L"Memory &Notes");
        AssertMenuItem(menu_ptr++, IDM_RA_PARSERICHPRESENCE, L"Rich &Presence Monitor");
        AssertMenuItem(menu_ptr++, 0, nullptr);
        AssertMenuItem(menu_ptr++, IDM_RA_FILES_POINTERFINDER, L"Pointer &Finder");
        AssertMenuItem(menu_ptr++, IDM_RA_FILES_POINTERINSPECTOR, L"Pointer &Inspector");
    }
    ...
    TEST_METHOD(TestGetPopupMenuItemsLoggedIn)
    {
        ...
        RA_MenuItem menu[32];
        Assert::AreEqual(25, _RA_GetPopupMenuItems(menu));
        const RA_MenuItem* menu_ptr = &menu[0];
        AssertMenuItem(menu_ptr++, IDM_RA_FILES_LOGOUT, L"Log&out");
        AssertMenuItem(menu_ptr++, 0, nullptr);
        AssertMenuItem(menu_ptr++, IDM_RA_OPENUSERPAGE, L"Open my &User Page");
        AssertMenuItem(menu_ptr++, IDM_RA_OPENGAMEPAGE, L"Open this &Game's Page");
        AssertMenuItem(menu_ptr++, 0, nullptr);
        AssertMenuItem(menu_ptr++, IDM_RA_HARDCORE_MODE, L"&Hardcore Mode");
        AssertMenuItem(menu_ptr++, IDM_RA_NON_HARDCORE_WARNING, L"Non-Hardcore &Warning");
        AssertMenuItem(menu_ptr++, IDM_RA_ONLY_HARDCORE_UNLOCKS, L"Only Hardcore Unloc&ks");
        ...
        AssertMenuItem(menu_ptr++, IDM_RA_FILES_POINTERINSPECTOR, L"Pointer &Inspector");
        AssertMenuItem(menu_ptr++, 0, nullptr);
        AssertMenuItem(menu_ptr++, IDM_RA_REPORTBROKENACHIEVEMENTS, L"&Report Achievement Problem");
        AssertMenuItem(menu_ptr++, IDM_RA_GETROMCHECKSUM, L"View Game H&ash");
    }
    ...
    TEST_METHOD(TestGetPopupMenuItemsChecked)
    {
        ...
        mockConfiguration.SetFeatureEnabled(ra::services::Feature::OnlyHardcoreUnlocks, true);
        ...
        AssertMenuItem(menu_ptr++, IDM_RA_OPENGAMEPAGE, L"Open this &Game's Page");
        AssertMenuItem(menu_ptr++, 0, nullptr);
        AssertMenuItem(menu_ptr++, IDM_RA_HARDCORE_MODE, L"&Hardcore Mode", true);
        AssertMenuItem(menu_ptr++, IDM_RA_NON_HARDCORE_WARNING, L"Non-Hardcore &Warning", true);
        AssertMenuItem(menu_ptr++, IDM_RA_ONLY_HARDCORE_UNLOCKS, L"Only Hardcore Unloc&ks", true);
        AssertMenuItem(menu_ptr++, 0, nullptr);
        AssertMenuItem(menu_ptr++, IDM_RA_TOGGLELEADERBOARDS, L"Enable &Leaderboards", true);
        AssertMenuItem(menu_ptr++, IDM_RA_OVERLAYSETTINGS, L"O&verlay Settings");
        AssertMenuItem(menu_ptr++, 0, nullptr);
        AssertMenuItem(menu_ptr++, IDM_RA_FILES_OPENALL, L"&Open All");
        AssertMenuItem(menu_ptr++, IDM_RA_FILES_ACHIEVEMENTS, L"Assets Li&st");
